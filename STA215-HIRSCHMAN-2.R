...
chisq.test(table(data$joey,data$chandler))

##################################################################################
#################### Step 4                 ####################   
##################################################################################

aov <- aov(humor ~ chandler, data = data)
summary(aov)
...
cor(data$humor, data$rating)

##################################################################################
#################### Step 6                 ####################   
##################################################################################

linear_relationship <-lm(data$rating~data$humor, data= data)
...
mean (data$humor)
mean (data$rating)
abline(a=NULL, b=NULL, h=6.2 , v=6.028571  ,col= "lightblue")
